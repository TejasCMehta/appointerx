(function () {
  ...
  /**
   * Introduce the appointerxApp.user module
   * and configure it.
   *
   * @requires ngResource
   * @requires ui.router
   * @requires {appointerxApp.admin.user.list}
   * @requires {appointerxApp.admin.user.create}
   */
  angular
    .module('appointerxApp.admin.user', [
      'ngResource',
      'ui.router',
      'appointerxApp.admin.user.list',
      'appointerxApp.admin.user.create'
    ])
