/**
 * @ngdoc overview
 * @name appointerxApp.admin.user.create
 * @description
 * The `appointerxApp.admin.user.create` module which provides
 *
 * - {@link appointerxApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
  ...
  angular
    .module('appointerxApp.admin.user.create', [
      ...
      'appointerxApp.auth',
      'appointerxApp.toast',
      'appointerxApp.remoteUnique',
      'appointerxApp.mongooseError'
    ])
