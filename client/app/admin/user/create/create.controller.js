/**
 * @ngdoc controller
 * @name appointerxApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
  ...
  angular
    .module('appointerxApp.admin.user.create')
    .controller('UserCreateController', UserCreateController);

  /**
   * @ngdoc function
   * @name appointerxApp.admin.user.create.provider:UserCreateController
   * @description
   * Provider of the {@link appointerxApp.admin.user.create.controller:UserCreateController UserCreateController}
   *
   ...
   * @returns {Service} {@link appointerxApp.admin.user.create.controller:UserCreateController UserCreateController}
   */
  ...
  function UserCreateController($mdDialog, Auth, User, Toast) {
     ...
     * @ngdoc property
     * @name userRoles
     * @propertyOf appointerxApp.admin.user.create.controller:UserCreateController
     * @description
     ...
     * @ngdoc function
     * @name create
     * @methodOf appointerxApp.admin.user.create.controller:UserCreateController
     * @description
