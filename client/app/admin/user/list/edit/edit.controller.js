/**
 * @ngdoc controller
 * @name appointerxApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name appointerxApp.admin.user.list.edit.provider:UserEditController
   * @description
   * Provider of the {@link appointerxApp.admin.user.list.edit.controller:UserEditController UserEditController}
