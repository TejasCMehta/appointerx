/**
 * @ngdoc controller
 * @name appointerxApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
  ...
  angular
    .module('appointerxApp.admin.user.list.edit')
    .controller('EditPasswordController', EditPasswordController);


  /**
   * @ngdoc function
   * @name appointerxApp.admin.user.list.edit.provider:EditPasswordController
   * @description
   * Provider of the {@link appointerxApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   *
   ...
   * @returns {Service} {@link appointerxApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   */
  ...
  function EditPasswordController($mdDialog, UserService, user, Toast) {
     ...
     * @ngdoc function
     * @name changePassword
     * @methodOf appointerxApp.admin.user.list.edit.controller:EditPasswordController
     * @description
