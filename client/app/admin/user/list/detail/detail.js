/**
 * @ngdoc overview
 * @name appointerxApp.admin.user.list.detail
 * @description
 * The `appointerxApp.admin.user.list.detail` module which provides:
 *
 * - {@link appointerxApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires appointerxApp.auth.user
 */
(function () {
  'use strict';
